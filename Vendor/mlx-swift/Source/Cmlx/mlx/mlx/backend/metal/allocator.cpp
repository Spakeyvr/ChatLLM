...
MetalAllocator::MetalAllocator()
  ...
  // CoreSimulator supports Metal buffers and compute, but its MTLHeap shim
  // aborts instead of returning an error. The allocator already falls back
  // to device buffers whenever heap_ is nil.
  return;
#endif
