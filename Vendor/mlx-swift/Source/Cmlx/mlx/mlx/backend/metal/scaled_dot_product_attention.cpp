...
bool ScaledDotProductAttention::use_fallback(
  ...
  // MLX's fused vector-attention kernels require 1024 threads per
  // threadgroup, while CoreSimulator Metal exposes a 512-thread maximum.
  // Use the unfused GPU implementation (matmul + softmax) in the simulator.
  return true;
#endif
